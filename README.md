...
Start with the [documentation index](./docs/README.md). Detailed setup and usage
are in [docs/INSTALLATION.md](./docs/INSTALLATION.md), while runtime and design
...
Public-repository evidence, brand policy, Chrome Web Store readiness, and draft
listing copy are consolidated in
...
- Version 1.6.0 adds Southwest Rapid Rewards points and Flight Credits, expands
  United into separate `UA Miles`, `UA Pool`, and `UA TB` rows, and adds
  reversible local program visibility settings.
- Version 1.6.0 also moves compact Settings, Update, Export, and Import icons to
