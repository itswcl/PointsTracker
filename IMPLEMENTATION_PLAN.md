...
- In: United MileagePlus, Cathay Asia Miles, Air France Flying Blue, Virgin Atlantic Flying Club, Alaska Airlines Atmos Rewards, American AAdvantage, EVA Air Infinity MileageLands, British Airways Club, ANA Mileage Club, Delta SkyMiles, World of Hyatt, Hilton Honors, Marriott Bonvoy, IHG One Rewards, Wyndham Rewards, American Express Membership Rewards, Chase Ultimate Rewards, Citi ThankYou Rewards, Bilt Rewards, automatic account-page balance capture, member-number/expiration capture where applicable, manual overrides, local storage, JSON backup, compact popup, failure recovery, tests, and unpacked installation.
...
- [x] Implement all nineteen airline, hotel, and Credit Card adapters behind a shared parser contract.
...
Member-number selectors or approved hydrated fields for all fifteen airline and hotel programs were confirmed live by 07/25/2026. The four Credit Card rows intentionally do not collect member numbers or expiration data. Flying Blue, British Airways, and ANA require the same-tab secondary-page path. The rebuilt extension still needs the final end-to-end reload check.
