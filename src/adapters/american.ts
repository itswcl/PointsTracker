...
function readAmericanBalance(document: Document): number | null {
...
function hasCardholderExpirationExemption(text: string | null): boolean {
...
export function inspectAmerican(document: Document, rawUrl: string) {
